...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap -->
    <link href="../academy_admin/../academy_admin/../academy_admin/vendors/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- Font Awesome -->
    <link href="../academy_admin/../academy_admin/vendors/font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <!-- NProgress -->
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12">
                          <div class="weather-text">
                            <center><img src=../students/images/stud-feedback/'.$row['student_photo'].' alt='.$row['name'].' class="img-circle img-responsive" width="100px" height="100px" title='.$row['name'].' data-toggle="tooltip"></center>
                          </div>
                        </div>
                      </div>
