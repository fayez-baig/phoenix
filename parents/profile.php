...
// $action = "source/package_form.php";
        ...
        try 
        {
            ...
            // Make a sql query
            $sql = "SELECT * FROM register_online WHERE phone= '$user'";
                      ...
                      <div class="row">
                        <div class="col-sm-4">
                          <div class="weather-icon">
                            <img scr="students/images/student/'.$row['image'].'">

                          </div>
                        </div>
                        <div class="col-sm-12">
                          <div class="weather-text">
                            <img src="../'.$path.''.$row['image'].'" class="img-responsive img-circul" width="300px"height="200px">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row weather-days">
                        <div class="col-sm-12">
                          ...
                          <br>
                            ...
                            <a href="javascript:void(0)"  disabled>Cheange Profile</a>
                            </small>
                            </p>
