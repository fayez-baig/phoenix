                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12">
                          <div class="weather-text">
                            <center><img src=images/stud-feedback/'.$row['student_photo'].' alt='.$row['name'].' class="img-circle img-responsive" width="100px" height="100px" title='.$row['name'].' data-toggle="tooltip"></center>
                          </div>
                        </div>
                      </div>
