      ...
      <ul class="nav side-menu">
        ...
        <li><a><i class="fa fa-thumbs-o-up"></i>Student Feedback <span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
            ...
            <li><a href="add_stud_feedback.php">Add </a></li>
          </ul>
        </li>

        <li><a><i class="fa fa-calendar"></i> Attendaces <span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
            <li><a href="attendances.php">List All</a></li>
          </ul>
        </li>
        ...
        <li><a><i class="fa fa-tasks"></i> Fess Deatils <span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
