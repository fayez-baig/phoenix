<?php 
  include_once('login_check.php');
    ...
    try 
    {
        ...
        // Make a sql query
        $sql = "SELECT * FROM register_online where phone = :phone AND reg_id=:reg_id ";
...
<html lang="en">
  <head>
    ...
    <title>Phoenix Tutorials || Feedback || Dashboard</title>
    ...
    <link href="../academy_admin/vendors/bootstrap-datepicker/css/bootstrap-datepicker.min.css" rel="stylesheet">
  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
            <div class="x_panel">
                <form id="profileForm" action="source/profile_form.php" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                <?php 
                    ...
                    <div class="well">
                        <label class="tab-head">Profile Details</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="email" placeholder="Student email"  class="form-control" name="email" value="<?=$email?>" >
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Select Image<span class="required">*</span>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                <div style="background-size:cover; background-repeat:no-repeat; background-image:url('images/student/<?=$image?>')">
    ...
    <!-- jquery.inputmask -->
    <script src="../academy_admin/vendors/jquery.inputmask/dist/min/jquery.inputmask.bundle.min.js"></script>

    <script type="text/javascript" src="../academy_admin/js/jquery.custom-file-input.js"></script>
    <!-- bootstrap-datepicker -->
    <script src="../academy_admin/vendors/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>
    <!-- Jquery ajax form -->
