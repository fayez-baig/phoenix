...
$output = [];
        ...
        try 
        {
            ...
            //Make a sql query
            $sql = "SELECT * FROM toper ORDER BY id ASC Limit 12";
  ...
  try 
        ...
        try 
    {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        // Make a sql query
        $sql = "SELECT * FROM gallery order by id desc limit 12";
            ...
            <div class="col-sm-12 col-md-6 pl-0 pl-sm-15 pr-sm-15 sm-height-auto mt-sm-0 wow fadeInLeft animation-delay2">
              <div class="sm-height-auto" data-bg-img="images/about/h2.jpg">
                <div class="p-30">
                  ...
                  <p class="lead text-white-f1">"A great opportunity for students to choose a world full of knowledge with us." <br>
                  "So Join Us To Fly High Like A Phoenix Bird"
        ...
        <div class="row">
          ...
          <div class="col-md-7">
            <div class="p-40 pl-0">
              ...
              <form id="reservation_form" name="reservation_form" class="reservation-form" method="post" action="#"><h3 class="mt-0 line-bottom mb-40">Get A Free<span class="text-theme-color-2"> Registration Now!</span></h3>
                <div class="row">
                  <div class="col-sm-12">
        ...
        <div class="section-content">
          <div class="row">
                ...
                <div class="testimonial bg-theme-colored border-radius-10px p-20 mb-15">
                  ...
                  <div class="content mt-20">
                    <div class="thumb pull-left flip">
                      <img width="64px" height="64px" src="academy_admin/images/stud-feedback/'.$row['student_photo'] .'" alt="' . $row['name'] . '" class="img-circle">
                    </div>
            ...
            <div class="col-md-6 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
              <h3 class="text-uppercase ml-15 title line-bottom">Our <span class="text-theme-color-2 font-weight-700">Topper's</span></h3>
                ...
                <div class="col-xs-12 pr-0 col-sm-6 col-md-6 mb-20">
                  <div class="pricing table-horizontal maxwidth400">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="thumb">
                        <img class="img-fullwidth img-thumnail mb-sm-0" src="academy_admin/images/topper/'.$row1['image'] . '"  alt='. $row1['name'].' width="100px" height="150px" >
                        </div>
                      </div>
                      <div class="col-md-6 p-10 pl-sm-50">
                        <h4 class="mt-0 mb-5 mt-10"><a href="#" class="text-white">'. $row1['name'].'</a></h4>
                        <ul class="list-inline font-16 mb-5 text-white">
                          <li class="pr-0"><i class="fa fa-calendar mr-5"></i>'. $row1['year'].'  |</li>
                          <li class="pl-5"><i class="fa fa-trophy mr-5"></i>'. $row1['rank'] .'</li>
                        </ul>
                        <p class="mb-0 font-13 text-white mr-5 pr-10"><i class="fa fa-graduation-cap"></i> ' . $row1['class']. '</p>
          ...
          <div class="col-md-12">
            <div class="modal fade zoomInUp" id="myModal" data-backdrop="static" data-keyboard="false">
              ...
              <div class="modal-content">
                    <div class="modal-header" style="background: #720d1c; border-bottom: 1px solid #fa0991;">
                      <a class="close" data-dismiss="modal" style="color:red">X</a>
                      <center style="color:#000;"><strong>RATING</strong></center>
                    </div>
                    <div class="modal-body" style="background:#006400">
                      <center><input name="rating" value="0" id="rating_star" type="hidden" postID="1" /></center>
                        <div class="overall-rating">(Average Rating <span id="avgrat"><?php echo $ratingRow['average_rating']; ?></span>
                      Based on <span id="totalrat"><?php echo $ratingRow['rating_number']; ?></span>  rating)</span></div>
                                </div>
...
s1.async=true;
s1.src='https://embed.tawk.to/5e306b718e78b86ed8ab7f65/default';
s1.charset='UTF-8';
