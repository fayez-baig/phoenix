...
function processRating(val, attrVal){
    $.ajax({
        ...
        success : function(data) {
            if (data.status == 'ok') {
                alert('You have rated '+val+' to Phoenix Tutorials');
                        ...
                        rules:
                        {
                         ...
                         messages:
                         {
                          ...
                          form_message:{
                            ...
                            validmessage :"Message must contain only alphabets.",
                            minlength :"Message at least 20 characters"
                          }
                           ...
                           .done(function(data){
                              ...
                              if ( data.status==='success' ) {
                                ...
                                $('#errorDiv').slideDown('fast', function(){
                                  ...
                                  $('#btn-signup').html('Submit Request').prop('disabled', false);
    ...
    <section class="hidden">
      <div class="container">
        <div class="row">
          ...
          <center><div class="overall-rating">(Average Rating <span id="avgrat"><?php echo $ratingRow['average_rating']; ?></span>
