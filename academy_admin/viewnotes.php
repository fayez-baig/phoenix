                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right">
                        <a href="notes.php" class="btn btn-primary "><i class="fa fa-plus">Add New Notes</i></a>
                    </ul>
                      ...
                      <tbody class="responsive">
                        <?php
                          ...
                          echo' <tr>
                                  ...
                                  <td>
                                    <a href="#='.$row['id'].'" title="Update"><span class="glyphicon glyphicon-pencil"></span></a>
                                    <a href="source/delete_notes.php?id='.$row['id'].'" onclick = "return confirm(\'Do you really want to Delete?\')" title="delete"><span class="glyphicon glyphicon-trash"></span></a>
                                    <a href="pdfview.php?doc='.$row["pdf_file"].'"  target="_blank"><span class="glyphicon glyphicon-eye-open"></span></a>
                                  </td>
                                </tr>';
                                $countt++;
                    }
