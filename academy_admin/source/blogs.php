                      ...
                      <ul class="nav navbar-right panel_toolbox">
                        ...
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="post_update.php?id='.$row['id'].'" title="Update Event"><i class="fa fa-pencil-square-o"></i> Edit Event</a>
                      ...
                      <div class="row">
                        <div class="col-sm-12">
                          <div class="temperature">
                            '.$row['post_date'].'
                              <span class=pull-right>' . $row['post_location'] . '</span>
                      ...
                      <div class="row">
                        <div class="col-sm-4">
                          <div class="weather-icon">
                            <img scr=../images/'.$row['post_image'].'>

                          </div>
                        </div>
                        <div class="col-sm-12">
                          <div class="weather-text">
                            <img src=images/'.$row['post_image'].' style="    MAX-WIDTH: 100%;">
                          </div>
                        </div>
                      </div>
