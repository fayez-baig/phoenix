...
if (isset($_POST['submit']) && isset($_FILES['uploads'])) {
  ...
  if(empty($post_date) )
  {
    $validation .= "Please enter blog date.<br>";
  }
 ...
 if(empty($post_tag))
  {
    $validation .= "Please enter blog tagline.<br>";
  }
  ...
  try
  {
    ...
    //SQL query
    $sql = "INSERT INTO post(post_title, post_image, post_description, post_tag, post_date, update_date) 
                     VALUES (:post_title, :post_image, :post_description, :post_tag, :post_date,  Now())";
