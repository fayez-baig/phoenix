...
<!-- Page Title -->
<title>Phoenix Tutorials || Registration</title>
          ...
          <div class="container pb-100">
            <div class="row">
              <div class="col-md-6 col-md-push-3">
                <div class="text-center mb-60"><a href="#" class=""><img alt="" src="images/logo-wide.png" style="height: 89px;"></a></div>
                <div class="bg-lightest border-1px p-25">
                  ...
                  <form id="appointment_form" name="appointment_form" class="mt-30" method="post" action="http://kodesolution.com/demo/wxyz/w/learnpress/v2.0/demo/includes/appointment.php">
                    <div class="row">
                      <div class="col-sm-12">
    ...
    <div class="container p-20">
      <div class="row">
        <div class="col-md-12 text-center">
          <p class="mb-0">Copyright &copy;2016 Phoenix Tutorials. All Rights Reserved</p>
        </div>
      </div>
    </div>
  </footer>
