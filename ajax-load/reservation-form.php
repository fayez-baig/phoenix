...
<div class="p-40">
  <!-- Reservation Form Start-->
    <form id="reservation_form_popup" name="reservation_form" class="reservation-form" method="post" role="form" autocomplete="off" action=""><h3 class="mt-0 line-bottom text-theme-colored mb-40">Get Admission<span class="text-theme-colored font-weight-600"> Now!</span></h3>
      <div class="row">
        <div class="col-sm-12">
        <div id="errorDiv"></div>
        ...
        <div class="col-sm-6">
          <div class="form-group mb-30">
            <input name="reservation_pno" class="form-control required " type="text" placeholder="Parent No" aria-required="true">
                   <span class="help-block" id="error"></span>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group mb-30">
            <input name="reservation_dob" class="form-control required date-picker" type="text" placeholder="DOB" aria-required="true">
                   <span class="help-block" id="error"></span>
          </div>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-sm-6">
          <div class="form-group mb-30">
            <input name="reservation_address" class="form-control required " type="text" placeholder="address" aria-required="true">
                   <span class="help-block" id="error"></span>
          </div>
        </div>
        <div class="col-sm-12">
